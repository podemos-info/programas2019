...
Airbrake.configure do |c|
  ...
  c.project_id = Rails.application.secrets.airbrake[:project_id]
  c.project_key = Rails.application.secrets.airbrake[:api_key]

  c.host = Rails.application.secrets.airbrake[:host]
